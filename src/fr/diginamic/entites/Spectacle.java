...
public class Spectacle {
	 ...
	 * System.out.println("Vous êtes " + nbClient + " à vous êtes inscrit pour " +
	 * this.getNom()); } else if (capaciteMax - nbInscrits < nbClient) {
	 * System.out.println( "Vous êtes " + (capaciteMax - nbInscrits) +
	 * " à vous êtes inscrit pour " + this.getNom()); nbInscrits += capaciteMax -
	 * (nbInscrits);
	 * 
